...
let e = {
	"name": "Orago's Warm Theme",
	"colors": {
		"activityBar.activeBackground": "#73aab133",
		"activityBar.activeBorder": "#0099ad",
		"activityBar.background": shades[0],
		"activityBar.border": "#ece2c600",
		"activityBar.foreground": shades[9],
		...
		"editor.background": shades[3],
		"editor.findMatchBackground": "#8ce99a55",
		"editor.findMatchBorder": "#00010000",
		...
		"editor.foreground": shades[9],
		"editor.hoverHighlightBackground": "#60381b64",
		"editor.inactiveSelectionBackground": "#ade2eb55",
		"editor.lineHighlightBackground": "#472b16",
		"editor.lineHighlightBorder": "#d1ebef00",
		"editor.rangeHighlightBackground": "#f1e9d5a1",
		"editor.selectionBackground": "#10cff177",
		...
		"editorGutter.background": shades[2],
		...
		"editorOverviewRuler.border": "#da9918",
		...
		"editorWidget.background": shades[5],
		"editorWidget.border": "#e9ab0000",
		...
		"gitDecoration.modifiedResourceForeground": "#5a8ed6",
		"gitDecoration.untrackedResourceForeground": "#4da738",
		"input.background": "#70411d",
		"input.border": "#f2edde",
		...
		"list.activeSelectionBackground": shades[5],
		"list.activeSelectionForeground": shades[9],
		"list.dropBackground": "#cdcbb2",
		"list.errorForeground": "#c9481d",
		"list.focusBackground": shades[5],
		"list.focusForeground": shades[9],
		"list.highlightForeground": "#0099ad",
		"list.hoverBackground": shades[3],
		"list.hoverForeground": shades[9],
		"list.inactiveFocusBackground": shades[5],
		"list.inactiveSelectionBackground": shades[4],
		"list.inactiveSelectionForeground": "#949384",
		"list.warningForeground": "#e07a52",
		"listFilterWidget.background": shades[4],
		...
		"minimapGutter.modifiedBackground": "#9db814",
		...
		"panel.background": shades[4],
		"panel.border": shades[6],
		"panelTitle.activeBorder": shades[6],
		"panelTitle.activeForeground": shades[7],
		"panelTitle.inactiveForeground": shades[5],
		...
		"settings.modifiedItemIndicator": "#aabd00",
		...
		"tab.activeBackground": "#472b16",
		"tab.activeBorder": "#fef8ec",
		"tab.activeBorderTop": "#7a461f",
		"tab.activeForeground": "#aa8165",
		"tab.activeModifiedBorder": "#00b368",
		"tab.border": "#e6d7b2",
		"tab.inactiveBackground": "#2f1e11",
